...
public class HotMenuListAdapter extends RecyclerView.Adapter<HotMenuListAdapter.MyViewHolder> {
    ...
    public HotMenuListAdapter(Context mContext, List<MenuCategory> menuList) {
