...
public class MessageVoucherListAdapter extends RecyclerView.Adapter<MessageVoucherListAdapter.MyViewHolder> {
    ...
    public MessageVoucherListAdapter(Context mContext, List<PointHistory> pointHistoryList) {
