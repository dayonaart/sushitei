...
public class Menu implements Serializable
{
    ...
    public Menu(Integer id, String menuCategoryId, String isHotMenu, String name, String description, String price, String order, String createdAt, String updatedAt, Integer isWishlist, String image) {
        this.id = id;
        this.menuCategoryId = menuCategoryId;
        this.isHotMenu = isHotMenu;
        this.name = name;
