...
public class DisclaimerSushiteiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dee.setText("Disclaimer & Privacy  Policy");
        name.setText("Disclaimer & Privacy  Policy");
    }
    ...
    private void loadTermAndConditions() {
        ...
        Call<TermAndConditions> call = requestApi.disclaimer();
